...
но реально протестировать success-путь можно только после применения
0002 и установки пароля в admin_config. Блок №6 по коду закрыт полностью,
ждём применения миграций и обратной связи по порогу negative_streak=1
(см. заход 16).
Последнее обновление: 2026-07-13 (заход 18)
